...
function renew_coff_field!(::Rectangular,::SecondOrderUpwind, n::Int64, m::Int64, mu::Float64, rho::Float64, val::Vector{Float64}, b::Vector{Float64},alpha::Matrix{Float64},beta::Matrix{Float64},gamma::Matrix{Float64},Ja::Matrix{Float64},x_u::Matrix{Float64},x_v::Matrix{Float64},y_u::Matrix{Float64},y_v::Matrix{Float64}, U::Matrix{Float64}, V::Matrix{Float64},u::Matrix{Float64}, v::Matrix{Float64}, x_uv::Matrix{Float64}, y_uv::Matrix{Float64}, phi::Matrix{Float64}, S::Matrix{Float64},Ap::Matrix{Float64}, phi_symbol::Symbol, bounds::Vector{bound})
    for j = 1:m
        for i = 1:n
